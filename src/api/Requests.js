const requests = {
    ...
    fetchActiosMovies: `/discover/movie?api_key=${process.env.API_KEY}&with_genres=28`,
    fetchComendyMovies: `/discover/movie?api_key=${process.env.API_KEY}&with_genres=35`,
